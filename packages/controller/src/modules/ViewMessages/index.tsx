...
import { ViewMessagesQuery_messages, ViewMessagesQuery, ViewMessagesQueryVariables } from "../../schemaTypes";
...
export const newMessageSubscrition = gql`
subscription NewMessageSubscrition($listingId:String!){
        ...
        {({data,loading, subscribeToMore}) => {
            ...
            return children({
              ...
              subscribe: () => subscribeToMore({
                document: newMessageSubscrition,
                variables: {listingId},
