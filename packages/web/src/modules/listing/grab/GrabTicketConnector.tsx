            ...
            <h2 style={{padding:"1%"}}>HERE IS UR TICKY</h2>
                ...
                <div id="ticket-grab-container" style={{height:"100%"}}>
                    ...
                    <embed src={`https://s3-us-west-1.amazonaws.com/last-minute-ticket/${this.state.ticketId}`} type="application/pdf" width="100%" height="100%"/>            </div>
                        :
                        <div style={{textAlign:"center"}}>
                        <a style={{color:"red",fontFamily:"IBM Plex Sans",fontSize:"30px"}} href={`https://s3-us-west-1.amazonaws.com/last-minute-ticket/${this.state.ticketId}`}>DOWNLOAD</a><br/>
                        <img id="ticket-grab" src={`https://s3-us-west-1.amazonaws.com/last-minute-ticket/${this.state.ticketId}`} /></div>
                    }
